      ...
      <div className="container-custom pt-16 pb-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          <div>
            ...
            <p className="text-white/70 mb-6">
              Transforma tu cuerpo y tu mente con rutinas personalizadas por IA,
              planes nutricionales y una comunidad que te impulsa.
            </p>
        ...
        <div className="pt-8 border-t border-white/20 flex flex-col md:flex-row justify-between items-center">
          <div className="text-white/60 text-sm mb-4 md:mb-0">
            &copy; {currentYear} FitLife Pro. Todos los derechos reservados.
          </div>
          <div className="flex items-center">
            <div className="text-sm mr-4">
              <select
                className="bg-transparent border border-white/20 rounded px-3 py-1 text-white/70 focus:outline-none focus:border-white/50"
              >
